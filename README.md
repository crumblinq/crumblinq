...
Сейчас работаю в e-commerce, имею экономический бэкграунд, и мне нравится разбираться в цифрах, таблицах и данных. Здесь я публикую часть выполненных проектов по анализу данных, машинному обучению и SQL.
